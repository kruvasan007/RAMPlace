...
import ru.cft.shift2023winter.Screen.MainFragmentDirections


class LocationAdapter(
    private var locationsList: List<Locations>,
    private val characterDataList: List<ru.cft.shift2023winter.Model.Character>
) :
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val expandablePart: LinearLayout =
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (currentPosition == position) {
            ...
            demension.text = location.dimension
